          ...
          children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            AppConstant.commonText('1 Position',
                                fontSize: 12.sp,
                                maxLines: 1,
                                textOverflow: TextOverflow.ellipsis,
                        ...
                        ListTile(
                          ...
                          subtitle: Row(
                            children: [
                              ...
                              width(10.w),
                              AppConstant.commonText('ThorChain',
                                  fontSize: 14.sp,
                                  fontWeight: FontWeight.w400,
                                  color: Theme.of(context)
                                      .colorScheme
                          ...
                          title: AppConstant.commonText('BTC/USDT',
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w500,
                              color: Theme.of(context).colorScheme.shadow),
            ...
            Container(
              ...
              child: ExpansionTile(
                  ...
                  leading: CachedNetworkImage(
                    imageUrl:
                    'https://i.ibb.co/YBWYdWS/sun-fog.png',
                    height: 35.h,
                    width: 35.w,
                    placeholder: (context, url) => const SizedBox(),
                  ),
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            AppConstant.commonText('Yield Pools',
                                fontSize: 16.sp,
                                maxLines: 1,
                                textOverflow: TextOverflow.ellipsis,
                                fontWeight: FontWeight.w500,
