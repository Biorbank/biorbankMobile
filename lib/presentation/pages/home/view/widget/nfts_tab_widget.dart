...
class _NFTsTabWidgetState extends State<NFTsTabWidget> {
  ...
  List<Map<String, String>> hooliganCollection = [
    ...
    },
    {
      "title": "Hooligan #4120",
      "imageUrl":
          "https://i.seadn.io/s/raw/files/beac1f64192aa51674d2c224c746c739.png?auto=format&dpr=1&w=750"
    },
    {
      "title": "Hooligan #5692",
      "imageUrl":
          "https://i.seadn.io/s/raw/files/c2d8d3bd88df96dee357dbdfe645a1ec.png?auto=format&dpr=1&w=750"
    },
    {
      "title": "Hooligan #3599",
      "imageUrl":
      ...
      return GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              context.router.push(NftHoldingRoute(
                  imageUrl: hooligan['imageUrl']!, title: hooligan['title']!));
