        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
              shrinkWrap: true,
              padding: const EdgeInsets.only(left: 4,right: 4,top: 14,bottom: 35),
                  ...
                  Expanded(
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          AppConstant.commonText('My Pet Hooligan',
                              fontWeight: FontWeight.w500,
                              maxLines: 1,
                          ...
                          Row(
                            children: [
                              ...
                              width(8.w),
                              Expanded(
                                child: AppConstant.commonText('14.3499',
                                    fontWeight: FontWeight.w500,
                                    maxLines: 1,
                                    textOverflow: TextOverflow.ellipsis,
                                    fontSize: 12.sp,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          width(6.w),
                          AppConstant.commonText('14.3499',
                              fontWeight: FontWeight.w500,
                              fontSize: 14.sp,
                              color: Theme.of(context).colorScheme.shadow),
                        ],
