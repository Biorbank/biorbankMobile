...
class BuyTapWidget extends StatefulWidget {
  const BuyTapWidget({super.key});

  @override
  State<BuyTapWidget> createState() => _BuyTapWidgetState();
}

class _BuyTapWidgetState extends State<BuyTapWidget> {
  @override
  void initState() {
